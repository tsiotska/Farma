...
export type MarksSortableProps = 'LPUName' | 'name';

interface IProps extends WithStyles<typeof styles> {
    toggleAll: () => void;
    propName: MarksSortableProps;
    anchor: HTMLElement;
    onClose: () => void;
    isLoading: boolean;
...
@observer
class MarksFilterPopper extends Component<IProps> {
    ...
    readonly titles: Record<MarksSortableProps, string> = {
        'LPUName': 'ЛПУ',
        'name': 'ПІБ лікаря',
    };
...
export default withStyles(styles)(MarksFilterPopper);
